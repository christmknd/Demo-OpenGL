...
void earthR_init(void) {
  int i;
  SDL_Surface * t;
  int vp[4], w, h;

  static char * files[] = {"images/boulet-de-canon.jpg", "images/epee.png","images/marine.jpg", "images/pistolet.png","images/Canon_de_pirate.png", "images/land_ocean_ice_2048_glossmap.png","images/one.jpg", "images/land_ocean_ice_2048_glossmap.png"};
...
//planete terre
 glActiveTexture(GL_TEXTURE0);
  glBindTexture(GL_TEXTURE_2D, _tId[0]);
  gl4duPushMatrix(); {
    gl4duRotatef(a0, 0, 1, 0); //rotation 
    gl4duTranslatef(0, 0, 0);  //mouvement
    gl4duScalef(0.5, 1, 0.5); // taille
    gl4duSendMatrices();
  } gl4duPopMatrix();
  glUniform1i(glGetUniformLocation(_pId, "specular"), 0);
  gl4dgDraw(_sphere);
