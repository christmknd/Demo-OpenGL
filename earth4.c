...
void earth4_init(void) {
  ...
  static char * files[] = {"images/one.jpg", "images/land_ocean_ice_2048_glossmap.png","images/one.jpg", "images/land_ocean_ice_2048_glossmap.png"};
...
//planete terre
 glActiveTexture(GL_TEXTURE0);
  ...
  gl4duPushMatrix(); {
    ...
    gl4duScalef(1.0, 1.5, 1.0); // taille
    gl4duSendMatrices();
  } gl4duPopMatrix();
  glUniform1i(glGetUniformLocation(_pId, "specular"), 0);
  gl4dgDraw(_sphere);
